...
if(isset($_SESSION['index_no'])){
    ...
    function showUsers($connection){
        ...
        $query_1 = mysqli_query($connection, "SELECT * FROM login");
    ...
    function showUserInfo($connection){
         ...
         while ($results_2 = mysqli_fetch_array($query_2) ) {
            ...
            $disability = $results_2['disability'];
            $city = $results_2['city'];
            ...
            $home_add = $results_2['home_add'];
             ...
             echo"<br><br>
                    <div class='row'>
                        ...
                        <div class='col-sm-2'>" . $disability . "</div>
                        ...
                        <div id="Paris" class="tabcontent content col-9">
                                ...
                                <form action="" method="post">
                                        <table cellspacing=20px cellpadding="15px">
                                            ...
                                            <tr>
                                                 <td>
                                                        <i class="fas fa-open-book"></i>  Disability:
                                                </td>
                                                <td>
                                                        <select class=form-control name="disable" id="">
                                                ...
                                                <td>
                                                    <input type="text" name="affect_area" class="form-control">
                                                    <small id="emailHelp" class="form-text text-muted">Which part of your body are you disabled</small>
